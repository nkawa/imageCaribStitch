...
import { FileTable } from "components/Tables";
    ...
    <>
      <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        ...
        <div className="btn-toolbar mb-2 mb-md-0">
          <Button variant="gray-800" size="sm" className="d-inline-flex align-items-center" onClick={getFileList}>
            <PlusIcon className="icon icon-xs me-2" /> CheckFolder
          </Button>
